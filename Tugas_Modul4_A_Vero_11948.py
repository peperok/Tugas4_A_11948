...
st.set_page_config(
    page_title="11948 - Unsupervised Learning",  
    page_icon="📈",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Vero</h1>", unsafe_allow_html=True)  # YYYYY diisi dengan nama panggilan
    st.dataframe(input_data)


model_directory = r'D:\UAJY\UAJY_sem_5\ML\ML4\Unsupervised Learning (Praktek)\Unsupervised Learning (Praktek)\Tugas4_A_11948'
model_path = {
